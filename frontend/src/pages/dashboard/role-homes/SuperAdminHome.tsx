...
const SuperAdminHome: React.FC = () => (
  <div className="space-y-8">
    <RoleGreeting
      actions={[
        { label: "System health", variant: "secondary", icon: <ServerCog className="h-4 w-4" /> },
        { label: "Add user", icon: <Plus className="h-4 w-4" /> },
      ]}
    />
    ...
    <div className="grid lg:grid-cols-3 gap-6">
      <QuickActions
        actions={[
          { label: "New tenant", icon: <Plus className="h-4 w-4" />, tone: "indigo" },
          { label: "Reset user", icon: <KeyRound className="h-4 w-4" />, tone: "amber" },
          { label: "Re-sync tenant", icon: <RefreshCcw className="h-4 w-4" />, tone: "sky" },
          { label: "Open audit log", icon: <Activity className="h-4 w-4" />, tone: "slate" },
        ]}
      />
